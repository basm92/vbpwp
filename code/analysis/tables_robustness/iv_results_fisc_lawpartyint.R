...
knitr::opts_current$set(label = "ivresults_fisc_lawpartyint")
...
modelsummary(ivres, 
             ...
             output = "./tables/iv_results_fisc_lawpartyint.tex",
    ...
    kableExtra::save_kable("./tables/iv_results_fisc_lawpartyint.tex")